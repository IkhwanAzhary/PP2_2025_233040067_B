 ...
 */
package id.ac.unpas.pratikumpemograman2.Modul10.view;
...
import id.ac.unpas.pratikumpemograman2.Modul10.model.KoneksiDB;
import javax.swing.*;
import java.awt.*;
...
public class MahasiswaApp extends JFrame {
    ...
    public MahasiswaApp() {
        setTitle("Aplikasi Mahasiswa - Latihan & Tugas Modul 10");
        setSize(700, 600);
        ...
        btnHapus.addActionListener(e -> hapusData()); // Pemanggilan fungsi hapus
    ...
    private void hapusData() {
        ...
        if (konfirmasi == JOptionPane.YES_OPTION) {
            try {
                ...
                // POP-UP INI YANG TADI TIDAK MUNCUL
