 ...
 */
package id.ac.unpas.pratikumpemograman2.Modul7;
...
public class ManajemenNilaiSiswaApp extends JFrame {
    ...
    private JPanel createInputPanel() {
        ...
        String[] matkul = {"Matematika Dasar", "Bahasa Indonesia", "Algoritma dan Pemograman I", "Pratikum Pemograman II"};
        ...
        panel.add(new JLabel("")); // Placeholder kosong agat tombol di kanan
        panel.add(btnSimpan);
    ...
    private void prosesSimpan() {
        ...
        // 4. Masukan ke Table (Update Model)
    ...
    public ManajemenNilaiSiswaApp() {
        ...
        // 3. Membuat Panel untuk Tab 1 (From Input)
